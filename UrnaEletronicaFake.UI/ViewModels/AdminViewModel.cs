...
public partial class AdminViewModel : ViewModelBase
{
    ...
    public AdminViewModel(IEleicaoService eleicaoService, IAuditoriaService auditoriaService, ITerminalLogService terminalLogService, ILogger<AdminViewModel> logger) : base(logger)
    {
        ...
        SalvarEleicaoCommand = new RelayCommand(async () => await SalvarEleicaoAsync());
    ...
    private async Task SalvarEleicaoAsync()
    {
        try
        {
            IsLoading = true;
    ...
    private Task EditarEleicao()
    {
        ...
        DescricaoEleicao = EleicaoSelecionada.Descricao ?? string.Empty;
    ...
    private async Task EditarCandidato()
    {
        ...
        FotoCandidato = CandidatoSelecionado.Foto ?? "";
